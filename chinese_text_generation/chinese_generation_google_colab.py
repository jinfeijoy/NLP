...
class Net(pl.LightningModule):
    def __init__(
        ...
        self.data = [json.loads(line.strip()) for line in open(data_path, 'r', encoding = 'utf-8')]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--batch_size", default=1, type=int, required=False, help="训练batch size"  #default is 8, use 1 as test
    )
